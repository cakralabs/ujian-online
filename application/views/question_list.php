...
<br> 
		...
		?>	
					...
					<form method="post" action="<?php echo site_url('qbank/pre_question_list/0/'.$cid.'/'.$lid);?>">
					<select   name="cid">
...
<form method="post" action="<?php echo site_url('qbank/remove_all');?>">	
...
?>
<tr>
 <td><input class="checkbox" type="checkbox" name="check[]" value="<?php echo $val['qid'];?>"></td>
 <td>  <a href="javascript:show_question_stat('<?php echo $val['qid'];?>');">+</a>  
<?php
	if(cid == "0"){
		echo $val['qid'];		
        }else{
