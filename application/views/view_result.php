...
?>
<tr><td><?php echo $this->lang->line('first_name');?></td><td><?php echo $result['first_name'].' '.$result['last_name'];?></td></tr>

<tr><td><?php echo $this->lang->line('quiz_name');?></td><td><?php echo $result['quiz_name'];?></td></tr>
<tr><td><?php echo 'Waktu Ujian';?></td><td><?php echo date('Y-m-d H:i:s',$result['start_time']);?></td></tr>
<tr><td><?php echo 'Waktu Mengerjakan (min)';?></td><td><?php echo intval($result['total_time']/60);?></td></tr>
<tr><td>Jawaban Benar</td><td><?php echo $result['score_obtained']/$result['correct_score'];?></td><tr>
<tr><td>Jawaban Salah</td><td><?php echo $result['noq']-($result['score_obtained']/$result['correct_score']);?></td></tr>
<tr><td><?php echo $this->lang->line('score_obtained');?></td><td><?php echo ($result['score_obtained']/$result['noq'])*100;?></td></tr>
