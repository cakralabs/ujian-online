...
<br> 
 <div class="login-panel panel panel-default">
	...
	if($jumlah['sebelum'] > 0){
		...
		echo "<a href='".base_url()."/index.php/qbank/edit_question_5/".$sebelum."' class='btn btn-primary'>Sebelumnya</a> ";
	}
	?><button class="btn btn-default" type="submit"><?php echo $this->lang->line('submit');?></button>
	<?php
	if($jumlah['sesudah'] > 0){
		$sesudah = intval($qid)+1;
		echo " <a href='".base_url()."/index.php/qbank/edit_question_5/".$sesudah."' class='btn btn-info'>Berikutnya</a>";
        }
	?>
