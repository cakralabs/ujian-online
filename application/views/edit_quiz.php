...
<br> 
 <div class="login-panel panel panel-default">
		...
		?>	
			...
			<div class="form-group">
				<label for="inputEmail" >Aktifkan Kuis</label><br>
				<input type="radio" name="show" value="1" <?php if($quiz['show']==1){echo 'checked';}?>>Ya</input> &nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio" name="show" value="0" <?php if($quiz['show']==0){echo 'checked';}?>>Tidak</input>
			</div>
