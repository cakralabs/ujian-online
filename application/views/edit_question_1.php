...
<?php echo $this->lang->line('multiple_choice_single_answer');?>
	...
	<?php
	if($jumlah['sebelum'] > 0){
		$sebelum = intval($qid)-1;
		echo "<a href='".base_url()."/index.php/qbank/edit_question_1/".$sebelum."' class='btn btn-primary'>Sebelumnya</a> ";
	}
	?>
	...
	<button class="btn btn-default" type="submit"><?php echo $this->lang->line('submit');?></button>
 	<?php
	if($jumlah['sesudah'] > 0){
		$sesudah = intval($qid)+1;
		echo " <a href='".base_url()."/index.php/qbank/edit_question_1/".$sesudah."' class='btn btn-info'>Berikutnya</a>";
        }
	?>
		</div>
</div>
